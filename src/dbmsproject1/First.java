...
public class First extends javax.swing.JFrame {
   /* private String USER="root";
    ...
    private String URL="jdbc:mysql://localhost/Parking";  */
    /**
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dbmsproject1/71egjxNwM5L._SX679_.jpg"))); // NOI18N
  ...
  /*       Connection con=null;
    ...
    try
    {
        ...
        if(con!=null)
        {
            ...
            JOptionPane.showMessageDialog(null,"Connected successfully","Message",JOptionPane.INFORMATION_MESSAGE);
        }
        }
    catch(Exception e)
    {
   ...
   /* finally
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         DeletionTable deletetab=new DeletionTable();
